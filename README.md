...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/empty-dream-47fe)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/empty-dream-47fe
```

A live public deployment of this template is available at [https://empty-dream-47fe.templates.workers.dev](https://empty-dream-47fe.templates.workers.dev)
